...
def test_dashboard_form_validation():
    ...
    assert_('marketing-nav-toggle' in landing and 'marketing-nav-open' in landing, 'landing phone hamburger menu styles')
    nav_js = (ROOT / 'js/nav.js').read_text()
    assert_('ensureMarketingMobileNav' in nav_js and 'marketingNavToggle' in nav_js, 'nav.js phone hamburger toggle')
